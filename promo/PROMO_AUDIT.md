...
## Routes / screens used
- `audit/screenshots/final-ready/flegartech-site/01-desktop.png` → shown as `flegartech.com`
- `audit/screenshots/final-ready/flegartech-site/03-projects.png` → shown as `flegartech.com/projects`
- Mobile: `audit/screenshots/final-ready/flegartech-site/02-mobile.png`
...
- `videos/01-instagram-reel.mp4` (5.3 MB)
- `videos/02-tiktok.mp4` (5.3 MB)
- `videos/03-youtube-short.mp4` (5.3 MB)
- `videos/04-linkedin-demo.mp4` (6.9 MB)
- `videos/05-x-demo.mp4` (5.2 MB)
- `videos/06-facebook-demo.mp4` (6.9 MB)
- `videos/07-github-readme-demo.mp4` (3.9 MB)
- `videos/08-portfolio-hero.mp4` (6.9 MB)
- `videos/gifs/github-readme-demo.gif` (6.4 MB)
- `videos/gifs/short-demo.gif` (9.0 MB)
...
**Screens/routes used:** Home (flegartech.com), Projects page + mobile view.
